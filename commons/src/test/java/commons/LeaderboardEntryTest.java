...
public class LeaderboardEntryTest {
    ...
    public void checkConstructor() {
        var le = new LeaderboardEntry(1,"name", 100);
    ...
    public void equalsHashCode() {
        var le1 = new LeaderboardEntry(1,"name", 100);
        var le2 = new LeaderboardEntry(1,"name", 100);
    ...
    public void notEqualsHashCode() {
        var le1 = new LeaderboardEntry(1, "name1", 101);
        var le2 = new LeaderboardEntry(2,"name2", 102);
    ...
    public void hasToString() {
        var le1 = new LeaderboardEntry(1,"name", 100).toString();
